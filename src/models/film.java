...
// Nhưng để khớp với code của bạn, tôi giữ nguyên 'film'
public class film { 
    ...
    public film(long maPhim, String tenPhim, int thoiLuongPhut, String theLoai, String phanLoai, String ngayPhatHanh, String trangThai) {

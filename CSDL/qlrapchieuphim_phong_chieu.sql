...
CREATE TABLE `phong_chieu` (
  ...
  KEY `FK_PHONG_CH_THUOCCHIN_CHI_NHAN` (`TenTP`,`Ten_Xa_Phuong`,`MaCN`),
  CONSTRAINT `FK_PHONG_CH_THUOCCHIN_CHI_NHAN` FOREIGN KEY (`TenTP`, `Ten_Xa_Phuong`, `MaCN`) REFERENCES `chi_nhanh` (`TenTP`, `Ten_Xa_Phuong`, `MaCN`)
...
INSERT INTO `phong_chieu` VALUES ('P001','TPHCM','Bến Nghé','CN001','PHÒNG 1');

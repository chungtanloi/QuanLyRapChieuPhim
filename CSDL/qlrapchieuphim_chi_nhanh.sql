...
CREATE TABLE `chi_nhanh` (
  ...
  CONSTRAINT `FK_CHI_NHAN_CHINHANHT_XA_PHUON` FOREIGN KEY (`TenTP`, `Ten_Xa_Phuong`) REFERENCES `xa_phuong` (`TenTP`, `Ten_Xa_Phuong`)
...
INSERT INTO `chi_nhanh` VALUES ('TPHCM','Bến Nghé','CN001','CGV Nguyễn Huệ');

...
CREATE TABLE `xa_phuong` (
  ...
  CONSTRAINT `FK_XA_PHUON_THUOCTHAN_THANHPHO` FOREIGN KEY (`TenTP`) REFERENCES `thanhpho` (`TenTP`)
...
LOCK TABLES `xa_phuong` WRITE;
/*!40000 ALTER TABLE `xa_phuong` DISABLE KEYS */;
INSERT INTO `xa_phuong` VALUES ('TPHCM','Bến Nghé');
/*!40000 ALTER TABLE `xa_phuong` ENABLE KEYS */;
UNLOCK TABLES;

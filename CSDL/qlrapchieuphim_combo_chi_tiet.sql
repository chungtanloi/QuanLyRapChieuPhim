...
CREATE TABLE `combo_chi_tiet` (
  ...
  KEY `FK_CBCT_SP` (`MaSP`),
  CONSTRAINT `FK_CBCT_COMBO` FOREIGN KEY (`MaCombo`) REFERENCES `combo` (`MaCombo`),
  CONSTRAINT `FK_CBCT_SP` FOREIGN KEY (`MaSP`) REFERENCES `san_pham` (`MaSP`)
...
INSERT INTO `combo_chi_tiet` VALUES ('CB01','PPC01',1),('CB01','SOD02',2);
